...
public class StreamApiMethods
{
    ...
    public static void reduceMethod(List<Integer> t){
        // demonstration of reduce method
        int even = t.stream().filter(x->x%2==0).reduce(0,(j,i)-> j+i);
    ...
    public static void toLowercase(List<String> names){
        ...
        Stream<String> stringStream = stream1.map((value) ->   value.toLowerCase() );
